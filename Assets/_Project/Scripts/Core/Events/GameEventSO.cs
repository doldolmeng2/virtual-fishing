...
namespace VirtualFishing.Core.Events
{
    ...
    [CreateAssetMenu(menuName = "VirtualFishing/Events/Float Event")]
    public class FloatEventSO : GameEventSO<float> { }

    [CreateAssetMenu(menuName = "VirtualFishing/Events/Int Event")]
    public class IntEventSO : GameEventSO<int> { }

    [CreateAssetMenu(menuName = "VirtualFishing/Events/String Event")]
